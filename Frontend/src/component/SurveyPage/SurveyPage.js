...
const SurveyPage = () => {
    ...
    const handleSubmit = (e) => {
        fetch("https://survay-form-backend.onrender.com/createsurvey",{
            method:"Post",
            headers:{
        ...
        .then((res)=>res.json())
        .then((result)=> navigate("/Questions"))
    ...
    //     const res = await axios.post("https://survay-form-backend.onrender.com/createsurvey", {
    //         "name": name,
    //         "description": description,
    //         "startDate": startDate,
    //         "endDate": endDate,
